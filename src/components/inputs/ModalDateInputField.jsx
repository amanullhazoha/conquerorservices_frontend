      ...
      <div className="flex gap-2 items-center" ref={selectRef}>
        <div className="relative w-full">
          <button
            ...
            className={`w-full mt-1.5 px-3 py-2 text-sm border rounded-lg focus:outline-none focus:border-[#1B345E] bg-[#F9FAFB] flex gap-2
